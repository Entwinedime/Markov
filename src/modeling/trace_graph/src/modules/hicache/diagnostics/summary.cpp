...
Json transition_json(const HiCacheStateTransition & transition, bool emit_digest) {
    Json row{
        ...
        {         "source_dur",         transition.source_dur },
...
Json policy_decision_json(const HiCachePolicyDecisionRecord & decision) {
    return Json{
        ...
        {                        "source_ts",                        decision.source_ts },
        {                       "source_dur",                       decision.source_dur },
...
std::string summary_json(const HiCacheSummary & summary) {
    ...
    root["dag_patch"] = Json{
        ...
        {                 "policy_decision_count",                 summary.dag_patch_policy_decision_count },
        {                      "transition_count",                      summary.dag_patch_transition_count },
        {                     "scoped_node_count",                     summary.dag_patch_scoped_node_count },
        {            "scoped_interval_node_count",            summary.dag_patch_scoped_interval_node_count },
        {                    "scoped_interval_ns",                    summary.dag_patch_scoped_interval_ns },
        {                      "shape_edge_count",                      summary.dag_patch_shape_edge_count },
        {      "skipped_reverse_shape_edge_count",      summary.dag_patch_skipped_reverse_shape_edge_count },
        {                          "window_count",                          summary.dag_patch_window_count },
        {            "window_interval_node_count",            summary.dag_patch_window_interval_node_count },
        {                    "window_interval_ns",                    summary.dag_patch_window_interval_ns },
        {                 "physical_window_count",                 summary.dag_patch_physical_window_count },
        {                   "physical_node_count",                   summary.dag_patch_physical_node_count },
        {          "physical_interval_node_count",          summary.dag_patch_physical_interval_node_count },
        {                  "physical_interval_ns",                  summary.dag_patch_physical_interval_ns },
        {             "physical_shape_edge_count",             summary.dag_patch_physical_shape_edge_count },
        {       "physical_duration_mutation_count",       summary.dag_patch_physical_duration_mutation_count },
        {            "physical_source_duration_ns",            summary.dag_patch_physical_source_duration_ns },
        {           "physical_mutated_duration_ns",           summary.dag_patch_physical_mutated_duration_ns },
        {             "physical_duration_delta_ns",             summary.dag_patch_physical_duration_delta_ns },
        {             "target_wait_carrier_count",             summary.dag_patch_target_wait_carrier_count },
        {       "target_wait_carrier_duration_ns",       summary.dag_patch_target_wait_carrier_duration_ns },
        {          "source_wait_gap_mutation_count",          summary.dag_patch_source_wait_gap_mutation_count },
        {     "source_wait_gap_interval_node_count",     summary.dag_patch_source_wait_gap_interval_node_count },
        {      "source_wait_gap_source_interval_ns",      summary.dag_patch_source_wait_gap_source_interval_ns },
        {     "source_wait_gap_mutated_interval_ns",     summary.dag_patch_source_wait_gap_mutated_interval_ns },
        {       "source_wait_gap_interval_delta_ns",       summary.dag_patch_source_wait_gap_interval_delta_ns },
        {             "source_wait_gap_base_scale",             summary.dag_patch_source_wait_gap_base_scale },
        {      "source_wait_gap_device_host_scale",      summary.dag_patch_source_wait_gap_device_host_scale },
        {          "source_best_effort_cleanup_gap_mutation_count",          summary.dag_patch_source_best_effort_cleanup_gap_mutation_count },
        {     "source_best_effort_cleanup_gap_interval_node_count",     summary.dag_patch_source_best_effort_cleanup_gap_interval_node_count },
        {      "source_best_effort_cleanup_gap_source_interval_ns",      summary.dag_patch_source_best_effort_cleanup_gap_source_interval_ns },
        {     "source_best_effort_cleanup_gap_mutated_interval_ns",     summary.dag_patch_source_best_effort_cleanup_gap_mutated_interval_ns },
        {       "source_best_effort_cleanup_gap_interval_delta_ns",       summary.dag_patch_source_best_effort_cleanup_gap_interval_delta_ns },
        {             "source_best_effort_cleanup_gap_scale",             summary.dag_patch_source_best_effort_cleanup_gap_scale },
        {                   "cost_mutation_count",                   summary.dag_patch_cost_mutation_count },
        {              "cost_interval_node_count",              summary.dag_patch_cost_interval_node_count },
        {               "cost_source_interval_ns",               summary.dag_patch_cost_source_interval_ns },
        {              "cost_mutated_interval_ns",              summary.dag_patch_cost_mutated_interval_ns },
        {                "cost_interval_delta_ns",                summary.dag_patch_cost_interval_delta_ns },
        {                   "cost_interval_scale",                   summary.dag_patch_cost_interval_scale },
        { "cost_unattributed_interval_node_count", summary.dag_patch_cost_unattributed_interval_node_count },
        {         "cost_unattributed_interval_ns",         summary.dag_patch_cost_unattributed_interval_ns },
        {                "cost_source_work_units",                summary.dag_patch_cost_source_work_units },
        {                "cost_target_work_units",                summary.dag_patch_cost_target_work_units },
        {                "cost_source_intent_units",                summary.dag_patch_cost_source_intent_units },
        {                "cost_target_intent_units",                summary.dag_patch_cost_target_intent_units },
        {  "cost_source_blocking_result_score",  summary.dag_patch_cost_source_blocking_result_score },
        {  "cost_target_blocking_result_score",  summary.dag_patch_cost_target_blocking_result_score },
        {          "cost_source_wait_score",          summary.dag_patch_cost_source_wait_score },
        {          "cost_target_wait_score",          summary.dag_patch_cost_target_wait_score },
        { "cost_source_wait_residue_scale", summary.dag_patch_cost_source_wait_residue_scale },
        { "cost_target_wait_carrier_score", summary.dag_patch_cost_target_wait_carrier_score },
        { "cost_source_best_effort_cleanup_scale", summary.dag_patch_cost_source_best_effort_cleanup_scale },
        { "cost_result_cleanup_policy_scale", summary.dag_patch_cost_result_cleanup_policy_scale },
        {           "cost_result_effect_scale",           summary.dag_patch_cost_result_effect_scale },
        {          "cost_prefill_compute_scale",          summary.dag_patch_cost_prefill_compute_scale },
        {       "cost_result_io_blocking_scale",       summary.dag_patch_cost_result_io_blocking_scale },
        {       "critical_path_interval_node_count",       summary.dag_patch_critical_path_interval_node_count },
        {              "critical_path_interval_ns",              summary.dag_patch_critical_path_interval_ns },
        { "critical_path_hicache_interval_node_count", summary.dag_patch_critical_path_hicache_interval_node_count },
        {        "critical_path_hicache_interval_ns",        summary.dag_patch_critical_path_hicache_interval_ns },
        {        "critical_path_hicache_edge_count",        summary.dag_patch_critical_path_hicache_edge_count },
        {                  "cost_work_unit_model",                  summary.dag_patch_cost_work_unit_model },
        {       "cost_interval_attribution_model",       summary.dag_patch_cost_interval_attribution_model },
        {                 "intent_by_policy_area",                 summary.dag_patch_intent_by_policy_area },
        {                        "intent_by_role",                        summary.dag_patch_intent_by_role },
        {                   "shape_edges_by_kind",                   summary.dag_patch_shape_edges_by_kind },
        {                 "shape_edges_by_impact",                 summary.dag_patch_shape_edges_by_impact },
        {               "scoped_interval_by_role",               summary.dag_patch_scoped_interval_by_role },
        {               "window_interval_by_kind",               summary.dag_patch_window_interval_by_kind },
        {                "physical_nodes_by_kind",                summary.dag_patch_physical_nodes_by_kind },
        {              "physical_nodes_by_impact",              summary.dag_patch_physical_nodes_by_impact },
        {             "physical_interval_by_kind",             summary.dag_patch_physical_interval_by_kind },
        {           "physical_interval_by_impact",           summary.dag_patch_physical_interval_by_impact },
        {          "physical_shape_edges_by_kind",          summary.dag_patch_physical_shape_edges_by_kind },
        {        "physical_shape_edges_by_impact",        summary.dag_patch_physical_shape_edges_by_impact },
        {      "physical_source_duration_by_effect",      summary.dag_patch_physical_source_duration_by_effect },
        {     "physical_mutated_duration_by_effect",     summary.dag_patch_physical_mutated_duration_by_effect },
        { "physical_duration_node_count_by_effect", summary.dag_patch_physical_duration_node_count_by_effect },
        {      "physical_duration_scale_by_effect",      summary.dag_patch_physical_duration_scale_by_effect },
        {          "cost_source_interval_by_kind",          summary.dag_patch_cost_source_interval_by_kind },
        {         "cost_mutated_interval_by_kind",         summary.dag_patch_cost_mutated_interval_by_kind },
        {        "cost_source_interval_by_effect",        summary.dag_patch_cost_source_interval_by_effect },
        {       "cost_mutated_interval_by_effect",       summary.dag_patch_cost_mutated_interval_by_effect },
        {        "cost_source_interval_by_impact",        summary.dag_patch_cost_source_interval_by_impact },
        {       "cost_mutated_interval_by_impact",       summary.dag_patch_cost_mutated_interval_by_impact },
        {       "cost_interval_scale_by_effect",       summary.dag_patch_cost_interval_scale_by_effect },
        {    "cost_interval_node_count_by_effect",    summary.dag_patch_cost_interval_node_count_by_effect },
        {    "cost_interval_node_count_by_impact",    summary.dag_patch_cost_interval_node_count_by_impact },
        {      "cost_source_work_units_by_effect",      summary.dag_patch_cost_source_work_units_by_effect },
        {      "cost_target_work_units_by_effect",      summary.dag_patch_cost_target_work_units_by_effect },
        {      "cost_source_work_units_by_impact",      summary.dag_patch_cost_source_work_units_by_impact },
        {      "cost_target_work_units_by_impact",      summary.dag_patch_cost_target_work_units_by_impact },
        { "cost_source_work_units_by_effect_policy_area", summary.dag_patch_cost_source_work_units_by_effect_policy_area },
        { "cost_target_work_units_by_effect_policy_area", summary.dag_patch_cost_target_work_units_by_effect_policy_area },
        { "cost_source_work_units_by_impact_policy_area", summary.dag_patch_cost_source_work_units_by_impact_policy_area },
        { "cost_target_work_units_by_impact_policy_area", summary.dag_patch_cost_target_work_units_by_impact_policy_area },
        { "cost_source_intent_units_by_effect_policy_area", summary.dag_patch_cost_source_intent_units_by_effect_policy_area },
        { "cost_target_intent_units_by_effect_policy_area", summary.dag_patch_cost_target_intent_units_by_effect_policy_area },
        { "cost_source_intent_units_by_impact_policy_area", summary.dag_patch_cost_source_intent_units_by_impact_policy_area },
        { "cost_target_intent_units_by_impact_policy_area", summary.dag_patch_cost_target_intent_units_by_impact_policy_area },
        { "critical_path_hicache_interval_by_kind", summary.dag_patch_critical_path_hicache_interval_by_kind },
        { "critical_path_hicache_interval_by_effect", summary.dag_patch_critical_path_hicache_interval_by_effect },
        { "critical_path_hicache_interval_by_impact", summary.dag_patch_critical_path_hicache_interval_by_impact },
        { "critical_path_hicache_edges_by_kind", summary.dag_patch_critical_path_hicache_edges_by_kind },
        { "critical_path_hicache_edges_by_impact", summary.dag_patch_critical_path_hicache_edges_by_impact },
        { "cost_source_work_units_by_policy_area", summary.dag_patch_cost_source_work_units_by_policy_area },
        { "cost_target_work_units_by_policy_area", summary.dag_patch_cost_target_work_units_by_policy_area },
        {        "cost_source_work_units_by_role",        summary.dag_patch_cost_source_work_units_by_role },
        {        "cost_target_work_units_by_role",        summary.dag_patch_cost_target_work_units_by_role },
        {          "cost_model_scale_by_effect",          summary.dag_patch_cost_model_scale_by_effect },
        {                              "warnings",                              summary.dag_patch_warnings },
    };
