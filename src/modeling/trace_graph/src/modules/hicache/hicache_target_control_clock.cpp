/**
 * @file
 * @brief HiCache target control clock。
 */
...
HiCacheControlCheckpoint HiCacheTargetControlClock::record_target_checkpoint(const std::string & cache_scope, const std::string & request_key,
                                                                             const std::string & check_kind, uint64_t ts, bool terminal,
                                                                             size_t source_event_index) {
    return record_checkpoint(cache_scope, request_key, check_kind, "target_scheduler_from_source_anchor", source_event_index, ts, terminal);
}
