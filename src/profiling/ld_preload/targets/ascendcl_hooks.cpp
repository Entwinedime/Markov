...
int aclrt_synchronize_event_hook(void * event) {
    return HOOKFW_INVOKE(aclrt_synchronize_event,
                         {
...
int __attribute__((noinline, visibility("default"))) aclrt_synchronize_event_with_timeout_hook(void * event,
                                                                                               int32_t timeout) asm("aclrtSynchronizeEventWithTimeout");
...
int aclrt_synchronize_device_with_timeout_hook(int32_t timeout) {
    return HOOKFW_INVOKE(aclrt_synchronize_device_with_timeout,
                         {
                             { "timeout", std::to_string(timeout) }
    },
                         timeout);
