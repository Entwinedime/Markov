...
__attribute__((always_inline)) inline auto InvokeHook(HookTarget<FnType> & target, std::initializer_list<HookArgInfo> trace_args, Args &&... args)
    -> decltype(target.Original()(std::forward<Args>(args)...)) {
