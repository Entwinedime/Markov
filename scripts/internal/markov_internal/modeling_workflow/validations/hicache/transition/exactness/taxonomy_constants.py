...
OBSERVED_ROLE_TO_OPERATION_KIND = {
    ...
    "loadback_decision_observed": "device_loadback",
    "loadback_io_observed": "device_loadback",
    "commit_device_to_host_enqueue_observed": "host_backup",
    "commit_device_to_host_io_observed": "host_backup",
    "commit_capacity_release_observed": "host_backup",
    "writeback_enqueue_observed": "write_back_flush",
    "writeback_io_observed": "write_back_flush",
    "prefetch_io_observed": "prefetch_read",
