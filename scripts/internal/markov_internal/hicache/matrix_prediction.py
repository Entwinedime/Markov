"""Prediction artifacts and summaries for HiCache state matrices."""
...
from .matrix_types import PredictionSpec, ProfileRun, safe_slug
...
def write_target_model_config(target: ProfileRun, config_dir: Path) -> Path:
    ...
    payload = {
        "metadata": {
            "purpose": "Generated by scripts/internal/entrypoints/hicache_workflow.py for matrix final-state prediction.",
