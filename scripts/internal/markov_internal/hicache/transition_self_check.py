...
from .transition_replay import compare_replay_final_state, replay_predicted_records
    ...
    for ordinal, record in enumerate(records):
        ...
        if source_index is None or not source_name:
            without_source.append(
                {"ordinal": ordinal, "transition_kind": record.get("transition_kind"), "source_event_index": source_index}
            )
