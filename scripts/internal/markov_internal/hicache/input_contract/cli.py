...
from .signature.core import DEFAULT_ROLES
from .reporting.report import InputContractReportOptions, build_report


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    """解析 cross-input audit CLI 参数。"""

    parser = argparse.ArgumentParser(description="Audit cross-config HiCache workload identity state-model facts.")
    parser.add_argument(
        "--source-trace",
        type=Path,
        action="append",
